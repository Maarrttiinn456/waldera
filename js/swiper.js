                ...
                Array.isArray(o.controller.control)
                    ...
                    : o.controller.control instanceof o.constructor &&
                      ...
                      o.controller.control.loopFix({
                          ...r,
                          slideTo:
                              o.controller.control.params.slidesPerView === m.slidesPerView && t,
                      });
            }
            o.emit('loopFix');
        },
    ...
    const be = [
        ...
        function ({ swiper: e, extendParams: t, on: s, emit: i }) {
            ...
            function y(t) {
                ...
                let r;
                ((r =
                    (v(t) - b(i)[e.isHorizontal() ? 'left' : 'top'] - (null !== o ? o : d / 2)) /
                    (c - d)),
        ...
        function ({ swiper: e, extendParams: t, on: s, emit: a }) {
            ...
            function T(t) {
                ...
                return (
                    !!t.target.matches(s) || e.slides.filter((e) => e.contains(t.target)).length > 0
                );
            }
            function M(t) {
            ...
            function z(t) {
                ...
                ((f.currentX =
                    f.touchesCurrent.x - f.touchesStart.x + f.startX + n * (f.width - 2 * l)),
                    (f.currentY =
                        f.touchesCurrent.y - f.touchesStart.y + f.startY + n * (f.height - 2 * p)),
                    f.currentX < f.minX &&
                ...
                s('beforeInit', () => {
                    if (
                        ...
                        return void (
                            ...
                            if (
                                (e.controller.control || (e.controller.control = []), t && t.swiper)
                            )
        ...
        function ({ swiper: e, extendParams: t, on: s }) {
            ...
            function d(t, s) {
                ...
                if (
                    ...
                    for (let t = 0; t < i; t += 1)
                        g(a.slidesEl, `[data-swiper-slide-index="${e.realIndex + t}"]`).forEach(
                            (e) => {
                                e.classList.add(r);
                            }
                        );
